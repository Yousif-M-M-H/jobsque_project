class JobIdModel {
  ...
  JobIdModel({this.status, this.data});

  JobIdModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null ? new JobByIdData.fromJson(json['data']) : null;
  }
...
class JobByIdData {
  ...
  JobByIdData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    image = json['image'];
